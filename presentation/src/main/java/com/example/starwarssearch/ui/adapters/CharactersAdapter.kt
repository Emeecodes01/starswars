...
class CharactersAdapter: ListAdapter<CharacterModel,CharactersAdapter.CharacterViewHolder>(CharacterDiffUtilCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CharacterViewHolder {
        val binding = LayoutCharacterItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CharacterViewHolder(private val binding: LayoutCharacterItemBinding): BaseViewHolder<CharacterModel>(binding){
